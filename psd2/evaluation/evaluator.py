...
def inference_on_dataset(
    ...
    if hasattr(evaluator, "supports_cached_inference") and evaluator.supports_cached_inference():
        logger.info("Using cached inference results; skipping model forward.")
